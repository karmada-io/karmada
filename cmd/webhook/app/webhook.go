...
func Run(ctx context.Context, opts *options.Options) error {
	...
	// ClusterTaintPolicy
	hookServer.Register("/validate-clustertaintpolicy", &webhook.Admission{Handler: &clustertaintpolicy.ValidatingAdmission{Client: hookManager.GetClient(), Decoder: decoder}})
