...
func (o *Options) AddFlags(fs *pflag.FlagSet, allControllers []string) {
	...
	fs.StringVar(&o.ClusterZone, "cluster-zone", "", "The zone of the joining cluster. The Karmada scheduler can use this information to spread workloads across zones for higher availability.")
