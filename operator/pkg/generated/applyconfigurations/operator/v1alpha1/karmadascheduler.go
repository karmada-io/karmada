...
// apply.
func KarmadaScheduler() *KarmadaSchedulerApplyConfiguration {
	return &KarmadaSchedulerApplyConfiguration{}
}
...
func (b *KarmadaSchedulerApplyConfiguration) WithImageRepository(value string) *KarmadaSchedulerApplyConfiguration {
...
func (b *KarmadaSchedulerApplyConfiguration) WithImageTag(value string) *KarmadaSchedulerApplyConfiguration {
...
func (b *KarmadaSchedulerApplyConfiguration) WithImagePullPolicy(value v1.PullPolicy) *KarmadaSchedulerApplyConfiguration {
...
func (b *KarmadaSchedulerApplyConfiguration) WithReplicas(value int32) *KarmadaSchedulerApplyConfiguration {
...
func (b *KarmadaSchedulerApplyConfiguration) WithLabels(entries map[string]string) *KarmadaSchedulerApplyConfiguration {
...
func (b *KarmadaSchedulerApplyConfiguration) WithAnnotations(entries map[string]string) *KarmadaSchedulerApplyConfiguration {
...
func (b *KarmadaSchedulerApplyConfiguration) WithResources(value *corev1.ResourceRequirementsApplyConfiguration) *KarmadaSchedulerApplyConfiguration {
...
func (b *KarmadaSchedulerApplyConfiguration) WithPriorityClassName(value string) *KarmadaSchedulerApplyConfiguration {
...
func (b *KarmadaSchedulerApplyConfiguration) WithPodDisruptionBudgetConfig(value *PodDisruptionBudgetConfigApplyConfiguration) *KarmadaSchedulerApplyConfiguration {
...
func (b *KarmadaSchedulerApplyConfiguration) WithTolerations(values ...*corev1.TolerationApplyConfiguration) *KarmadaSchedulerApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *KarmadaSchedulerApplyConfiguration) WithAffinity(value *corev1.AffinityApplyConfiguration) *KarmadaSchedulerApplyConfiguration {
...
func (b *KarmadaSchedulerApplyConfiguration) WithExtraArgs(entries map[string]string) *KarmadaSchedulerApplyConfiguration {
...
func (b *KarmadaSchedulerApplyConfiguration) WithFeatureGates(entries map[string]bool) *KarmadaSchedulerApplyConfiguration {
