...
// ImageRegistryApplyConfiguration constructs a declarative configuration of the ImageRegistry type for use with
// apply.
...
func (b *ImageRegistryApplyConfiguration) WithRegistry(value string) *ImageRegistryApplyConfiguration {
	b.Registry = &value
	return b
}
