...
func TestInitData(t *testing.T) {
	tests := []struct {
		...
		{
			name: "InitData_NoRunDataIsInitialized_InitlaizeRunDataWithError",
			job: &Job{
		...
		{
			name: "InitData_NoRunDataIsInitialized_InitlaizeRunData",
			job: &Job{
				runDataInitializer: func() (RunData, error) {
		...
		{
			name: "InitData_RunDataIsAlreadyInitialized_InitlaizeRunData",
			job: &Job{
				runDataInitializer: func() (RunData, error) {
					return &TestRunData{name: "test"}, nil
				},
