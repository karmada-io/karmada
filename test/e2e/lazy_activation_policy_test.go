...
var _ = ginkgo.Describe("[PolicyChanged] Lazy activation policy testing", func() {
	...
	assertNoRefreshBehavior := func() {
		ginkgo.It("should not perform the refresh of the binding", func() {
