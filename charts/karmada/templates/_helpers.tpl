...
{{ include "common.images.pullSecrets" (dict "images" (list .Values.cfssl.image .Values.kubectl.image .Values.scheduler.image .Values.webhook.image .Values.controllerManager.image .Values.apiServer.image .Values.aggregatedApiServer.image .Values.metricsAdapter.image .Values.kubeControllerManager.image .Values.etcd.internal.image .Values.agent.image .Values.descheduler.image .Values.schedulerEstimator.image .Values.search.image) "global" .Values.global) }}
{{- end -}}
