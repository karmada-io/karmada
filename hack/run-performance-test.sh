...
function run_performance_test() {
    ...
    cp "${REPO_ROOT}/hack/performance/clusterloader2-config.yaml" "${REPO_ROOT}/perf-tests/clusterloader2/config.yaml"
    cp "${REPO_ROOT}/hack/performance/clusterloader2-deployment.yaml" "${REPO_ROOT}/perf-tests/clusterloader2/deployment.yaml"
    cp "${REPO_ROOT}/hack/performance/clusterloader2-policy.yaml" "${REPO_ROOT}/perf-tests/clusterloader2/policy.yaml"
    cp "${REPO_ROOT}/hack/performance/clusterloader2-configmap.yaml" "${REPO_ROOT}/perf-tests/clusterloader2/configmap.yaml"
...
"${REPO_ROOT}"/hack/performance/collect-metrics.sh
