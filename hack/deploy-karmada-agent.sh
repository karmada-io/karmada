...
# create secret
kubectl --context="${MEMBER_CLUSTER_NAME}" create secret generic karmada-config --from-file=karmada.config="${KARMADA_APISERVER_KUBECONFIG}" -n "${KARMADA_SYSTEM_NAMESPACE}"
