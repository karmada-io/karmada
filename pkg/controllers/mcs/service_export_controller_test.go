...
func (e *mockErrorClient) Get(_ context.Context, _ types.NamespacedName, _ client.Object, _ ...client.GetOption) error {
	if e.getError != nil {
		return e.getError
	}
	return e.Client.Get(context.TODO(), types.NamespacedName{}, nil)
}

func (e *mockErrorClient) List(_ context.Context, _ client.ObjectList, _ ...client.ListOption) error {
	if e.listError != nil {
		return e.listError
	}
	return e.Client.List(context.TODO(), nil)
}

func (e *mockErrorClient) Delete(_ context.Context, _ client.Object, _ ...client.DeleteOption) error {
	if e.deleteError != nil {
		return e.deleteError
	}
	return e.Client.Delete(context.TODO(), nil)
}

func (e *mockErrorClient) Update(_ context.Context, _ client.Object, _ ...client.UpdateOption) error {
	if e.updateError != nil {
		return e.updateError
	}
	return e.Client.Update(context.TODO(), nil)
}
...
// mockSingleClusterManager simulates genericmanager.SingleClusterInformerManager
...
func (m *mockSingleClusterManager) Lister(gvr schema.GroupVersionResource) cache.GenericLister {
	if m.listerFunc != nil {
...
// mockInformerManager simulates genericmanager.MultiClusterInformerManager
type mockInformerManager struct {
	managers map[string]genericmanager.SingleClusterInformerManager
}

func (m *mockInformerManager) GetSingleClusterManager(clusterName string) genericmanager.SingleClusterInformerManager {
	if m.managers == nil {
		return nil
	}
...
func (m *mockInformerManager) IsManagerExist(_ string) bool { return false }
...
func TestGetEndpointSliceWorkMeta(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			meta, err := getEndpointSliceWorkMeta(ctx, c, namespace, workName, eps)
			tt.verify(t, meta, err)
		})
	}
}
	...
	}{
		{
			...
			prepare: func() (*ServiceExportController, client.Client) {
				...
				controller := &ServiceExportController{
					Client:          client,
					InformerManager: &mockInformerManager{managers: nil},
				}
			...
			prepare: func() (*ServiceExportController, client.Client) {
				...
				controller := &ServiceExportController{
					...
					InformerManager: &mockInformerManager{
						managers: map[string]genericmanager.SingleClusterInformerManager{
							clusterName: &mockSingleClusterManager{
								synced: false,
								listerFunc: func(_ schema.GroupVersionResource) cache.GenericLister {
									return &mockLister{
										getFunc: func(name string) (runtime.Object, error) {
											return nil, apierrors.NewNotFound(schema.GroupResource{}, name)
										},
		...
		},
		{
			...
			prepare: func() *ServiceExportController {
				...
				controller := &ServiceExportController{
					...
					InformerManager: &mockInformerManager{
						managers: map[string]genericmanager.SingleClusterInformerManager{
							clusterName: &mockSingleClusterManager{synced: false},
						},
					},
				}
				return controller
				...
				controller := &ServiceExportController{
					...
					InformerManager: &mockInformerManager{
						managers: map[string]genericmanager.SingleClusterInformerManager{
							clusterName: &mockSingleClusterManager{
								synced:     true,
								listerFunc: createMockListerWithEndpointSlices([]runtime.Object{eps1}),
							},
						},
					},
				...
				controller := &ServiceExportController{
					...
					InformerManager: &mockInformerManager{
						managers: map[string]genericmanager.SingleClusterInformerManager{
							clusterName: &mockSingleClusterManager{
								synced:     true,
								listerFunc: createMockListerWithEndpointSlices([]runtime.Object{eps1, eps2}),
							},
						},
					},
				...
				controller := &ServiceExportController{
					...
					InformerManager: &mockInformerManager{
						managers: map[string]genericmanager.SingleClusterInformerManager{
							clusterName: &mockSingleClusterManager{
								synced:     true,
								listerFunc: createMockListerWithEndpointSlices([]runtime.Object{}), // No EndpointSlices
							},
						},
					},
					// Provider that returns the orphan work
...
func TestRemoveOrphanWork(t *testing.T) {
	...
	createControllerWithProvider := func(works []*workv1alpha1.Work, providerWorks []*workv1alpha1.Work) (*ServiceExportController, workListProvider) {
		...
		controller := &ServiceExportController{Client: client}
...
func TestSyncServiceExportOrEndpointSlice(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			verify: func(t *testing.T, c client.Client, err error) {
				// Don't assert NoError yet, let's see what the actual error is
				if err != nil {
			...
			prepare: func() (*ServiceExportController, controllerruntime.Request) {
				...
				mockManager := &mockInformerManager{
					managers: map[string]genericmanager.SingleClusterInformerManager{
						clusterName: &mockSingleClusterManager{
							synced:        true,
							handlerExists: true, // All handlers exist
							listerFunc: func(_ schema.GroupVersionResource) cache.GenericLister {
								return &mockLister{}
							},
						},
