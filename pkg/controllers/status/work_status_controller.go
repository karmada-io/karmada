...
func (c *WorkStatusController) buildResourceInformers(cluster *clusterv1alpha1.Cluster, work *workv1alpha1.Work) (controllerruntime.Result, error) {
	...
	_, err = helper.RegisterInformerHandlerAndCheckSynced(cluster, gvrTargets, c.getEventHandler(), c.InformerManager, c.ClusterDynamicClientSetFunc, c.Client, c.ClusterClientOption)
	if err != nil {
