...
// BuildImageString generates the full image string in the format "ImageRepository:ImageTag"
// by combining the image repository and tag fields.
func (i *Image) BuildImageString() string {
	if i.ImageTag == "" || i.ImageRepository == "" {
		return ""
	}
	return i.ImageRepository + ":" + i.ImageTag
}
