		...
		Spec: config.KarmadaInitSpec{
			...
			Etcd: config.Etcd{
				Local: &config.LocalEtcd{
					CommonSettings: config.CommonSettings{
						Image: config.Image{
							ImageRepository: "etcd-image",
							ImageTag:        "latest",
						},
						Replicas: 3,
					},
					InitImage: config.Image{
						ImageRepository: "init-image",
						ImageTag:        "latest",
					},
					DataPath: "/data/dir",
					PVCSize:  "5Gi",
			...
			Components: config.KarmadaComponents{
				KarmadaAPIServer: &config.KarmadaAPIServer{
					CommonSettings: config.CommonSettings{
						Image: config.Image{
							ImageRepository: "apiserver-image",
							ImageTag:        "latest",
						},
						Replicas: 2,
					},
				...
				KarmadaControllerManager: &config.KarmadaControllerManager{
					CommonSettings: config.CommonSettings{
						Image: config.Image{
							ImageRepository: "controller-manager-image",
							ImageTag:        "latest",
						},
						Replicas: 2,
					},
				...
				KarmadaScheduler: &config.KarmadaScheduler{
					CommonSettings: config.CommonSettings{
						Image: config.Image{
							ImageRepository: "scheduler-image",
							ImageTag:        "latest",
						},
						Replicas: 2,
					},
				...
				KarmadaAggregatedAPIServer: &config.KarmadaAggregatedAPIServer{
					CommonSettings: config.CommonSettings{
						Image: config.Image{
							ImageRepository: "aggregated-apiserver-image",
							ImageTag:        "latest",
						},
						Replicas: 2,
					},
				...
				KubeControllerManager: &config.KubeControllerManager{
					CommonSettings: config.CommonSettings{
						Image: config.Image{
							ImageRepository: "kube-controller-manager-image",
							ImageTag:        "latest",
						},
						Replicas: 2,
					},
