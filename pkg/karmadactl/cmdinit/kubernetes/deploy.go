...
var (
	...
	defaultEctdImageAndVersion              = "etcd:3.5.1-0"
	defaultAPIServerImageAndVersion         = "kube-apiserver:v1.21.7"
	defaultControllerManagerImageAndVersion = "kube-controller-manager:v1.21.7"
)
...
func (i *CommandInitOption) kubeAPIServerImage() string {
	...
	return i.kubeRegistry() + "/" + defaultAPIServerImageAndVersion
}
...
func (i *CommandInitOption) kubeControllerManagerImage() string {
	...
	return i.kubeRegistry() + "/" + defaultControllerManagerImageAndVersion
}
...
func (i *CommandInitOption) etcdImage() string {
	...
	return i.kubeRegistry() + "/" + defaultEctdImageAndVersion
}
