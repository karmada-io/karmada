	...
	podSpec := corev1.PodSpec{
		...
		Volumes: []corev1.Volume{
			...
			},
			{
				...
				VolumeSource: corev1.VolumeSource{
					Secret: &corev1.SecretVolumeSource{
						SecretName: util.GetComponentClientCertName(names.KarmadaAPIServerComponentName, util.ServiceAccountKeyPair)},
				},
			},
		},
		//HostNetwork:  true,
	...
	podSpec := corev1.PodSpec{
		...
		Volumes: []corev1.Volume{
			...
			},
			{
				...
				VolumeSource: corev1.VolumeSource{
					Secret: &corev1.SecretVolumeSource{
						SecretName: util.GetComponentClientCertName(names.KubeControllerManagerComponentName, util.ServiceAccountKeyPair),
					},
				},
			},
		},
	...
	podSpec := corev1.PodSpec{
		...
		Volumes: []corev1.Volume{
			...
			},
			{
				...
				VolumeSource: corev1.VolumeSource{
					Secret: &corev1.SecretVolumeSource{
						SecretName: util.GetComponentCertName(util.Server),
					},
				},
			},
		},
