...
webhooks:
  ...
  - name: config.karmada.io
    ...
    sideEffects: None
    admissionReviewVersions: ["v1"]
    timeoutSeconds: 3`, systemNamespace, caBundle, systemNamespace, caBundle, systemNamespace, caBundle, systemNamespace, caBundle, systemNamespace, caBundle, systemNamespace, caBundle)
}
