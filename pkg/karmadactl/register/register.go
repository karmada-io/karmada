...
func NewCmdRegister(parentCommand string) *cobra.Command {
	...
	flags.StringVar(&opts.CACertPath, "ca-cert-path", "", "Deprecated, and will be removed in a future version.")
...
func (o *CommandRegisterOption) Complete(args []string) error {
	...
	if len(o.CACertPath) != 0 {
		klog.Warningf("Flag --ca-cert-path flag is deprecated, has no effect and will be removed in a future version.")
	}
