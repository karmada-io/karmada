...
func NewCmdExplain(f util.Factory, parentCommand string, streams genericiooptions.IOStreams) *cobra.Command {
	...
	flags.BoolVar(&o.ExplainFlags.Recursive, "recursive", o.ExplainFlags.Recursive, "When true, print the name of all the fields recursively. Otherwise, print the available fields with their description.")
	flags.StringVar(&o.ExplainFlags.APIVersion, "api-version", o.ExplainFlags.APIVersion, "Use given api-version (group/version) of the resource.")

	// Only enable --output as a valid flag if the feature is enabled
	flags.StringVar(&o.ExplainFlags.OutputFormat, "output", plaintextTemplateName, "Format in which to render the schema. Valid values are: (plaintext, plaintext-openapiv2).")
