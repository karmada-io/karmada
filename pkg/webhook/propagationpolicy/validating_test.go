...
func TestValidatingAdmission_Handle(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			want: admission.Denied("spec.resourceSelectors[0].namespace: Invalid value: \"ns-2\": namespace of resource selector must be equal to the namespace of the policy"),
		},
	}
