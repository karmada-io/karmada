...
func (v *ValidatingAdmission) validatePolicy(policy *policyv1alpha1.PropagationPolicy) error {
	...
	if errs := validation.ValidatePropagationSpec(policy.Spec, policy.Namespace); len(errs) != 0 {
