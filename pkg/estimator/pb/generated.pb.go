...
type ComponentReplicaRequirements struct {
	...
	// Deprecated: Writers cannot set this field in Kubernetes 1.35 and higher, and should set this field and resourceRequestBytes. Readers should prefer resourceRequestBytes if set.
	// +optional
	//
	// Deprecated: Marked as deprecated in pkg/estimator/pb/generated.proto.
...
type NodeClaim struct {
	...
	// Deprecated: Writers cannot set this field in Kubernetes 1.35 and higher, and should set this field and nodeAffinityBytes. Readers should prefer nodeAffinityBytes if set.
	// +optional
	//
	// Deprecated: Marked as deprecated in pkg/estimator/pb/generated.proto.
	NodeAffinity *v1.NodeSelector `protobuf:"bytes,1,opt,name=nodeAffinity,proto3" json:"nodeAffinity,omitempty"`
	...
	// Deprecated: Writers cannot set this field in Kubernetes 1.35 and higher, and should set this field and tolerationsBytes. Readers should prefer tolerationsBytes if set.
	// +optional
	//
	// Deprecated: Marked as deprecated in pkg/estimator/pb/generated.proto.
...
const file_pkg_estimator_pb_generated_proto_rawDesc = "" +
	"\n" +
	" pkg/estimator/pb/generated.proto\x12.github.com.karmada_io.karmada.pkg.estimator.pb\x1a\"k8s.io/api/core/v1/generated.proto\x1a4k8s.io/apimachinery/pkg/api/resource/generated.proto\"\xbb\x01\n" +
	"\tComponent\x12\x12\n" +
	...
	"\breplicas\x18\x03 \x01(\x05R\breplicas\"\x91\x05\n" +
	"\x1cComponentReplicaRequirements\x12W\n" +
	"\tnodeClaim\x18\x01 \x01(\v29.github.com.karmada_io.karmada.pkg.estimator.pb.NodeClaimR\tnodeClaim\x12\x8f\x01\n" +
	...
	"\vmaxReplicas\x18\x01 \x01(\x05R\vmaxReplicas\"\xa7\x03\n" +
	"\tNodeClaim\x12H\n" +
	"\fnodeAffinity\x18\x01 \x01(\v2 .k8s.io.api.core.v1.NodeSelectorB\x02\x18\x01R\fnodeAffinity\x12o\n" +
	...
	"\x04name\x18\x04 \x01(\tR\x04name\"\x94\x05\n" +
	"\x13ReplicaRequirements\x12W\n" +
	"\tnodeClaim\x18\x01 \x01(\v29.github.com.karmada_io.karmada.pkg.estimator.pb.NodeClaimR\tnodeClaim\x12\x86\x01\n" +
