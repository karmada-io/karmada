	...
	tests := []struct {
		...
		},
		{
			...
			cluster: clusterv1alpha1.Cluster{
				Spec: clusterv1alpha1.ClusterSpec{
					ResourceModels: []clusterv1alpha1.ResourceModel{
						{Ranges: []clusterv1alpha1.ResourceModelRange{{Name: corev1.ResourceCPU, Min: q("500m")}}},  // grade 0
						{Ranges: []clusterv1alpha1.ResourceModelRange{{Name: corev1.ResourceCPU, Min: q("1000m")}}}, // grade 1
						{Ranges: []clusterv1alpha1.ResourceModelRange{{Name: corev1.ResourceCPU, Min: q("2000m")}}}, // grade 2 (first compliant for 1500m)
					},
				},
				Status: clusterv1alpha1.ClusterStatus{
					ResourceSummary: &clusterv1alpha1.ResourceSummary{
		...
		},
		{
			...
			cluster: clusterv1alpha1.Cluster{
				Spec: clusterv1alpha1.ClusterSpec{
					ResourceModels: []clusterv1alpha1.ResourceModel{
						{Ranges: []clusterv1alpha1.ResourceModelRange{{Name: corev1.ResourceCPU, Min: q("1000m")}}}, // g0
						{Ranges: []clusterv1alpha1.ResourceModelRange{{Name: corev1.ResourceCPU, Min: q("2000m")}}}, // g1
					},
				},
				Status: clusterv1alpha1.ClusterStatus{
					ResourceSummary: &clusterv1alpha1.ResourceSummary{
