...
type Framework interface {
	...
	// The Result contains code, reasons and error.
	// It is merged from all plugins' returned result codes.
	RunEstimateComponentsPlugins(ctx context.Context, snapshot *schedcache.Snapshot, components []*pb.Component, namespace string, assumedWorkloads []*pb.AssumedWorkload) (int32, *Result)
...
type EstimateComponentsPlugin interface {
	...
	// The Result contains code, reasons and error.
	// It is merged from all plugins' returned result codes.
	EstimateComponents(ctx context.Context, snapshot *schedcache.Snapshot, components []*pb.Component, namespace string, assumedWorkloads []*pb.AssumedWorkload) (int32, *Result)
}
