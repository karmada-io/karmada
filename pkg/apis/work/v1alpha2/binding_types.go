...
type ResourceBindingSpec struct {
	...
	// ReschedulingConfig represents the rescheduling config for the referencing resource.
	// It inherits directly from the associated PropagationPolicy(or ClusterPropagationPolicy).
	// +optional
	ReschedulingConfig *policyv1alpha1.ReschedulingConfig `json:"reschedulingConfig,omitempty"`
