...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EvictionTask) DeepCopyInto(out *EvictionTask) {
	*out = *in
	if in.Replicas != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EvictionTask.
func (in *EvictionTask) DeepCopy() *EvictionTask {
	if in == nil {
		return nil
	}
	out := new(EvictionTask)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ResourceBindingSpec) DeepCopyInto(out *ResourceBindingSpec) {
	*out = *in
	...
	if in.EvictionTasks != nil {
		in, out := &in.EvictionTasks, &out.EvictionTasks
		*out = make([]EvictionTask, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
