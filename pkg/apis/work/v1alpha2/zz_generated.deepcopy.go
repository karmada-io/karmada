...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ComponentRequirements) DeepCopyInto(out *ComponentRequirements) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComponentRequirements.
func (in *ComponentRequirements) DeepCopy() *ComponentRequirements {
	if in == nil {
		return nil
	}
	out := new(ComponentRequirements)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ResourceBindingSpec) DeepCopyInto(out *ResourceBindingSpec) {
	*out = *in
	...
	if in.Components != nil {
		...
		*out = make([]ComponentRequirements, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
