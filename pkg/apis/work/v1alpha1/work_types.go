...
const (
	...
	// OrphaningDeletionPolicyAnnotation is added to resource template annotation to indicates how removal action of managed resources.
	OrphaningDeletionPolicyAnnotation = "orphaningdeletionpolicy.karmada.io"

	// OrphaningDeletionCompleteAnnotation means that the resource in member clusters completely independent of karmada
	...
	OrphaningDeletionCompleteAnnotation = "complete"
)
