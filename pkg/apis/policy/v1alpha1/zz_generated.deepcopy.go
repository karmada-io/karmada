...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TaintToAdd) DeepCopyInto(out *TaintToAdd) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TaintToAdd.
func (in *TaintToAdd) DeepCopy() *TaintToAdd {
	if in == nil {
		return nil
	}
	out := new(TaintToAdd)
