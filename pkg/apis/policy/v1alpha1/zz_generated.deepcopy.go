...
func (in *Overriders) DeepCopyInto(out *Overriders) {
	*out = *in
	...
	if in.PlaintextObjectOverrider != nil {
		in, out := &in.PlaintextObjectOverrider, &out.PlaintextObjectOverrider
		*out = make([]PlaintextObjectOverrider, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PlaintextObjectOverrider) DeepCopyInto(out *PlaintextObjectOverrider) {
	*out = *in
	if in.Plaintext != nil {
		in, out := &in.Plaintext, &out.Plaintext
		*out = make([]PlaintextOverrider, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PlaintextObjectOverrider.
func (in *PlaintextObjectOverrider) DeepCopy() *PlaintextObjectOverrider {
	if in == nil {
		return nil
	}
	out := new(PlaintextObjectOverrider)
	in.DeepCopyInto(out)
	return out
}
