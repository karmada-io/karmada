...
func (in *ClusterAffinityTerm) DeepCopyInto(out *ClusterAffinityTerm) {
	*out = *in
	...
	if in.OverflowAffinities != nil {
		in, out := &in.OverflowAffinities, &out.OverflowAffinities
		*out = make([]OverflowClusterAffinity, len(*in))
		for i := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OverflowClusterAffinity) DeepCopyInto(out *OverflowClusterAffinity) {
	*out = *in
	in.ClusterAffinity.DeepCopyInto(&out.ClusterAffinity)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OverflowClusterAffinity.
func (in *OverflowClusterAffinity) DeepCopy() *OverflowClusterAffinity {
	if in == nil {
		return nil
	}
	out := new(OverflowClusterAffinity)
	in.DeepCopyInto(out)
	return out
}
