...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OverriderVarSource) DeepCopyInto(out *OverriderVarSource) {
	*out = *in
	if in.FieldRef != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OverriderVarSource.
func (in *OverriderVarSource) DeepCopy() *OverriderVarSource {
	if in == nil {
		return nil
	}
	out := new(OverriderVarSource)
	in.DeepCopyInto(out)
	return out
}
