...
func (in *PropagationSpec) DeepCopyInto(out *PropagationSpec) {
	*out = *in
	...
	if in.ReschedulingTriggers != nil {
		in, out := &in.ReschedulingTriggers, &out.ReschedulingTriggers
		*out = make([]ReschedulingTrigger, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReschedulingConfig) DeepCopyInto(out *ReschedulingConfig) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReschedulingConfig.
func (in *ReschedulingConfig) DeepCopy() *ReschedulingConfig {
	if in == nil {
		return nil
	}
	out := new(ReschedulingConfig)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReschedulingTrigger) DeepCopyInto(out *ReschedulingTrigger) {
	*out = *in
	if in.Index != nil {
	...
	if in.ReschedulingConfig != nil {
		in, out := &in.ReschedulingConfig, &out.ReschedulingConfig
		*out = new(ReschedulingConfig)
		**out = **in
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReschedulingTrigger.
func (in *ReschedulingTrigger) DeepCopy() *ReschedulingTrigger {
	if in == nil {
		return nil
	}
	out := new(ReschedulingTrigger)
	in.DeepCopyInto(out)
	return out
}
