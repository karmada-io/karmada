...
type PropagationSpec struct {
	...
	// PriorityBasedPreemptiveScheduling feature gate. Preemption takes effect only when both gates are
	// enabled and the resolved priority class allows preempting lower-priority bindings.
	//
	// +optional
