...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ComponentRevision) DeepCopyInto(out *ComponentRevision) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComponentRevision.
func (in *ComponentRevision) DeepCopy() *ComponentRevision {
	if in == nil {
		return nil
	}
	out := new(ComponentRevision)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CustomizationRules) DeepCopyInto(out *CustomizationRules) {
	*out = *in
	...
	if in.ComponentRevision != nil {
		in, out := &in.ComponentRevision, &out.ComponentRevision
		*out = new(ComponentRevision)
		**out = **in
	}
...
func (in *ResourceInterpreterRequest) DeepCopyInto(out *ResourceInterpreterRequest) {
	*out = *in
	...
	if in.DesiredComponents != nil {
		in, out := &in.DesiredComponents, &out.DesiredComponents
		*out = make([]v1alpha2.TargetComponent, len(*in))
		copy(*out, *in)
	}
