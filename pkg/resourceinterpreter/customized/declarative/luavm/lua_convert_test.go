...
func TestConvertLuaResultToStruct(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if err := ConvertLuaResultInto(tt.args.luaResult, tt.args.obj, nil); (err != nil) != tt.wantErr {
...
func Test_convertEmptyObjectBackToEmptySlice(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := convertEmptySliceToEmptyStructPartly(tt.args.objBytes, true, tt.args.references)
			if (err != nil) != tt.wantErr {
