...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("memberclusters"):
		...
		// Group=propagatestrategy.karmada.io, Version=v1alpha1
	case propagationstrategyv1alpha1.SchemeGroupVersion.WithResource("propagationbindings"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Propagatestrategy().V1alpha1().PropagationBindings().Informer()}, nil
	case propagationstrategyv1alpha1.SchemeGroupVersion.WithResource("propagationworks"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Propagatestrategy().V1alpha1().PropagationWorks().Informer()}, nil
