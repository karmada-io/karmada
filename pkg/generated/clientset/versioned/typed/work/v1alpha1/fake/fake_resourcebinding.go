...
func (c *FakeResourceBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ResourceBinding, err error) {
	emptyResult := &v1alpha1.ResourceBinding{}
	obj, err := c.Fake.
...
func (c *FakeResourceBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ResourceBindingList, err error) {
	emptyResult := &v1alpha1.ResourceBindingList{}
	obj, err := c.Fake.
...
func (c *FakeResourceBindings) UpdateStatus(ctx context.Context, resourceBinding *v1alpha1.ResourceBinding, opts v1.UpdateOptions) (result *v1alpha1.ResourceBinding, err error) {
	emptyResult := &v1alpha1.ResourceBinding{}
	obj, err := c.Fake.
...
func (c *FakeResourceBindings) Apply(ctx context.Context, resourceBinding *workv1alpha1.ResourceBindingApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ResourceBinding, err error) {
...
func (c *FakeResourceBindings) ApplyStatus(ctx context.Context, resourceBinding *workv1alpha1.ResourceBindingApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ResourceBinding, err error) {
	if resourceBinding == nil {
		return nil, fmt.Errorf("resourceBinding provided to Apply must not be nil")
	}
	data, err := json.Marshal(resourceBinding)
