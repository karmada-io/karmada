...
type ClusterResourceBindingInterface interface {
	...
	Apply(ctx context.Context, clusterResourceBinding *workv1alpha1.ClusterResourceBindingApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ClusterResourceBinding, err error)
	// Add a +genclient:noStatus comment above the type to avoid generating ApplyStatus().
	ApplyStatus(ctx context.Context, clusterResourceBinding *workv1alpha1.ClusterResourceBindingApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ClusterResourceBinding, err error)
...
type clusterResourceBindings struct {
	*gentype.ClientWithListAndApply[*v1alpha1.ClusterResourceBinding, *v1alpha1.ClusterResourceBindingList, *workv1alpha1.ClusterResourceBindingApplyConfiguration]
}
...
func newClusterResourceBindings(c *WorkV1alpha1Client) *clusterResourceBindings {
	return &clusterResourceBindings{
		gentype.NewClientWithListAndApply[*v1alpha1.ClusterResourceBinding, *v1alpha1.ClusterResourceBindingList, *workv1alpha1.ClusterResourceBindingApplyConfiguration](
