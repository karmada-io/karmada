...
type ResourceBindingInterface interface {
	...
	Apply(ctx context.Context, resourceBinding *workv1alpha1.ResourceBindingApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ResourceBinding, err error)
	// Add a +genclient:noStatus comment above the type to avoid generating ApplyStatus().
	ApplyStatus(ctx context.Context, resourceBinding *workv1alpha1.ResourceBindingApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ResourceBinding, err error)
	ResourceBindingExpansion
}

// resourceBindings implements ResourceBindingInterface
type resourceBindings struct {
	*gentype.ClientWithListAndApply[*v1alpha1.ResourceBinding, *v1alpha1.ResourceBindingList, *workv1alpha1.ResourceBindingApplyConfiguration]
}
...
func newResourceBindings(c *WorkV1alpha1Client, namespace string) *resourceBindings {
	return &resourceBindings{
		gentype.NewClientWithListAndApply[*v1alpha1.ResourceBinding, *v1alpha1.ResourceBindingList, *workv1alpha1.ResourceBindingApplyConfiguration](
			"resourcebindings",
			c.RESTClient(),
