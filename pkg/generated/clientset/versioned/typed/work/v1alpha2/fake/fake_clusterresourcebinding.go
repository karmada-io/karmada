...
func (c *FakeClusterResourceBindings) Apply(ctx context.Context, clusterResourceBinding *workv1alpha2.ClusterResourceBindingApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha2.ClusterResourceBinding, err error) {
...
func (c *FakeClusterResourceBindings) ApplyStatus(ctx context.Context, clusterResourceBinding *workv1alpha2.ClusterResourceBindingApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha2.ClusterResourceBinding, err error) {
	if clusterResourceBinding == nil {
		return nil, fmt.Errorf("clusterResourceBinding provided to Apply must not be nil")
	}
	data, err := json.Marshal(clusterResourceBinding)
