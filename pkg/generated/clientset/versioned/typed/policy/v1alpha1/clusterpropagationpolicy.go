...
type ClusterPropagationPolicyInterface interface {
	...
	Apply(ctx context.Context, clusterPropagationPolicy *applyconfigurationspolicyv1alpha1.ClusterPropagationPolicyApplyConfiguration, opts v1.ApplyOptions) (result *policyv1alpha1.ClusterPropagationPolicy, err error)
...
type clusterPropagationPolicies struct {
	*gentype.ClientWithListAndApply[*policyv1alpha1.ClusterPropagationPolicy, *policyv1alpha1.ClusterPropagationPolicyList, *applyconfigurationspolicyv1alpha1.ClusterPropagationPolicyApplyConfiguration]
}
...
func newClusterPropagationPolicies(c *PolicyV1alpha1Client) *clusterPropagationPolicies {
	return &clusterPropagationPolicies{
		gentype.NewClientWithListAndApply[*policyv1alpha1.ClusterPropagationPolicy, *policyv1alpha1.ClusterPropagationPolicyList, *applyconfigurationspolicyv1alpha1.ClusterPropagationPolicyApplyConfiguration](
