...
type federatedResourceQuotas struct {
	*gentype.ClientWithList[*v1alpha1.FederatedResourceQuota, *v1alpha1.FederatedResourceQuotaList]
}
...
func newFederatedResourceQuotas(c *PolicyV1alpha1Client, namespace string) *federatedResourceQuotas {
	return &federatedResourceQuotas{
		gentype.NewClientWithList[*v1alpha1.FederatedResourceQuota, *v1alpha1.FederatedResourceQuotaList](
