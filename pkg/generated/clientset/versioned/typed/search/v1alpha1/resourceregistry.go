...
type resourceRegistries struct {
	*gentype.ClientWithList[*v1alpha1.ResourceRegistry, *v1alpha1.ResourceRegistryList]
}
...
func newResourceRegistries(c *SearchV1alpha1Client) *resourceRegistries {
	return &resourceRegistries{
		gentype.NewClientWithList[*v1alpha1.ResourceRegistry, *v1alpha1.ResourceRegistryList](
			"resourceregistries",
			c.RESTClient(),
