...
type FakePropagationBindings struct {
	Fake *FakePropagatestrategyV1alpha1
	ns   string
}

var propagationbindingsResource = schema.GroupVersionResource{Group: "propagatestrategy.karmada.io", Version: "v1alpha1", Resource: "propagationbindings"}

var propagationbindingsKind = schema.GroupVersionKind{Group: "propagatestrategy.karmada.io", Version: "v1alpha1", Kind: "PropagationBinding"}
