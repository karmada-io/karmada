...
// apply.
func BindingSnapshot() *BindingSnapshotApplyConfiguration {
	return &BindingSnapshotApplyConfiguration{}
}

// WithNamespace sets the Namespace field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the Namespace field is set to the value of the last call.
func (b *BindingSnapshotApplyConfiguration) WithNamespace(value string) *BindingSnapshotApplyConfiguration {
	b.Namespace = &value
	return b
}
...
func (b *BindingSnapshotApplyConfiguration) WithName(value string) *BindingSnapshotApplyConfiguration {
	b.Name = &value
	return b
}
...
func (b *BindingSnapshotApplyConfiguration) WithClusters(values ...*TargetClusterApplyConfiguration) *BindingSnapshotApplyConfiguration {
	for i := range values {
		if values[i] == nil {
