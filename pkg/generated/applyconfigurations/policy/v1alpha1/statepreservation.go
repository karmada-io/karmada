...
// StatePreservationApplyConfiguration constructs a declarative configuration of the StatePreservation type for use with
// apply.
func StatePreservation() *StatePreservationApplyConfiguration {
	return &StatePreservationApplyConfiguration{}
}

// WithRules adds the given value to the Rules field in the declarative configuration
// and returns the receiver, so that objects can be build by chaining "With" function invocations.
// If called multiple times, values provided by each call will be appended to the Rules field.
func (b *StatePreservationApplyConfiguration) WithRules(values ...*StatePreservationRuleApplyConfiguration) *StatePreservationApplyConfiguration {
	for i := range values {
		if values[i] == nil {
