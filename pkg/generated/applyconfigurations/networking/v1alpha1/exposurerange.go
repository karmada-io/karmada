...
// ExposureRangeApplyConfiguration constructs a declarative configuration of the ExposureRange type for use with
// apply.
func ExposureRange() *ExposureRangeApplyConfiguration {
	return &ExposureRangeApplyConfiguration{}
}
...
func (b *ExposureRangeApplyConfiguration) WithClusterNames(values ...string) *ExposureRangeApplyConfiguration {
	for i := range values {
