...
// StatusAggregationApplyConfiguration constructs a declarative configuration of the StatusAggregation type for use with
// apply.
func StatusAggregation() *StatusAggregationApplyConfiguration {
	return &StatusAggregationApplyConfiguration{}
}
...
func (b *StatusAggregationApplyConfiguration) WithLuaScript(value string) *StatusAggregationApplyConfiguration {
	b.LuaScript = &value
	return b
}
