...
// ReplicaRevisionApplyConfiguration constructs a declarative configuration of the ReplicaRevision type for use with
// apply.
func ReplicaRevision() *ReplicaRevisionApplyConfiguration {
	return &ReplicaRevisionApplyConfiguration{}
}
...
func (b *ReplicaRevisionApplyConfiguration) WithLuaScript(value string) *ReplicaRevisionApplyConfiguration {
	b.LuaScript = &value
	return b
}
