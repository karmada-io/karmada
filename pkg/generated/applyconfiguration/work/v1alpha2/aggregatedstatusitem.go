...
type AggregatedStatusItemApplyConfiguration struct {
	...
	Health         *v1alpha2.ResourceHealth `json:"health,omitempty"`
}
...
func (b *AggregatedStatusItemApplyConfiguration) WithHealth(value v1alpha2.ResourceHealth) *AggregatedStatusItemApplyConfiguration {
	b.Health = &value
	return b
}
