...
type clusterResourceBindingLister struct {
	listers.ResourceIndexer[*v1alpha1.ClusterResourceBinding]
}
...
func NewClusterResourceBindingLister(indexer cache.Indexer) ClusterResourceBindingLister {
	return &clusterResourceBindingLister{listers.New[*v1alpha1.ClusterResourceBinding](indexer, v1alpha1.Resource("clusterresourcebinding"))}
}
