...
type ResourceInterpreterCustomizationLister interface {
	...
	List(selector labels.Selector) (ret []*configv1alpha1.ResourceInterpreterCustomization, err error)
	// Get retrieves the ResourceInterpreterCustomization from the index for a given name.
	// Objects returned here must be treated as read-only.
	Get(name string) (*configv1alpha1.ResourceInterpreterCustomization, error)
...
type resourceInterpreterCustomizationLister struct {
	listers.ResourceIndexer[*configv1alpha1.ResourceInterpreterCustomization]
}
...
func NewResourceInterpreterCustomizationLister(indexer cache.Indexer) ResourceInterpreterCustomizationLister {
	return &resourceInterpreterCustomizationLister{listers.New[*configv1alpha1.ResourceInterpreterCustomization](indexer, configv1alpha1.Resource("resourceinterpretercustomization"))}
}
