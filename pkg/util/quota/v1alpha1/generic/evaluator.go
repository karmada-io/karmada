...
type InformerForResourceFunc func(schema.GroupVersionResource) (informerfactory.GenericInformer, error)
...
func Matches(
	resourceQuota *v1alpha1.KarmadaQuota, item runtime.Object,
...
func (o *objectCountEvaluator) Matches(resourceQuota *v1alpha1.KarmadaQuota, item runtime.Object) (bool, error) {
