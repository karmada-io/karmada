...
type ObjectWatcher interface {
	...
	GetVersionRecord(clusterName string, object *unstructured.Unstructured) (string, bool)
}
...
func (o *objectWatcherImpl) GetVersionRecord(clusterName string, object *unstructured.Unstructured) (string, bool) {
	return o.getVersionRecord(clusterName, object.GroupVersionKind().String()+"/"+object.GetNamespace()+"/"+object.GetName())
}
