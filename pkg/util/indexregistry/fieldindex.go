...
// RegisterWorkIndexByFieldSuspendDispatching registers Indexer functions to controller manager.
...
// RegisterResourceBindingIndexByFieldCluster registers Indexer functions to controller manager.
...
// RegisterClusterResourceBindingIndexByFieldCluster registers Indexer functions to controller manager.
