...
var (
	...
	KarmadaLabels = []string{
		...
		policyv1alpha1.ClusterPropagationPolicyLabel, policyv1alpha1.PropagationPolicyNameLabel,
...
func CleanUpLabelAnnotation(obj *unstructured.Unstructured) {
	...
	annonations := obj.GetAnnotations()
	if annonations != nil {
		for _, annonationKey := range KarmadaAnnotations {
			delete(annonations, annonationKey)
		}
		obj.SetAnnotations(annonations)
	}
}
