...
func validateClusterTaintEffect(effect *corev1.TaintEffect, allowEmpty bool, fldPath *field.Path) field.ErrorList {
	...
	switch *effect {
	case corev1.TaintEffectNoSchedule, corev1.TaintEffectNoExecute, policyv1alpha1.TaintEffectPreferNoExecute:
	default:
		validValues := []string{
			string(corev1.TaintEffectNoSchedule),
			string(corev1.TaintEffectNoExecute),
			string(policyv1alpha1.TaintEffectPreferNoExecute),
		}
