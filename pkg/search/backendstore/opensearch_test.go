...
func TestNewOpenSearch(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:        "NewOpenSearch_WithoutOpenSearchCredentialsSecret_SecretNotFoundUnauthorizedClient",
			clusterName: "member1",
			cfg: &searchv1alpha1.BackendStoreConfig{
				OpenSearch: &searchv1alpha1.OpenSearchConfig{
		...
		{
			name:        "NewOpenSearch_GetSecretFromK8SClient_GotNetworkIssue",
			clusterName: "member1",
			cfg: &searchv1alpha1.BackendStoreConfig{
				OpenSearch: &searchv1alpha1.OpenSearchConfig{
					Addresses: []string{"https://10.0.0.1:9200"},
		...
		{
			name:        "NewOpenSearch_CreateOpenSearchClient_FailedToCreateOpenSearchClient",
			clusterName: "member1",
			cfg: &searchv1alpha1.BackendStoreConfig{
				OpenSearch: &searchv1alpha1.OpenSearchConfig{
					Addresses: []string{"https://10.0.0.1:9200"},
...
func TestGetOrCreateIndex(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "GetOrCreateIndex_WithNetworkIssueInRequestErr_FailedToCreateIndex",
			us: &unstructured.Unstructured{
		...
		{
			name: "GetOrCreateIndex_WithNetworkIssueInResponse_FailedToCreateIndex",
			us: &unstructured.Unstructured{
				Object: map[string]interface{}{
					"apiVersion": "apps/v1",
					"kind":       "Deployment",
		...
		{
			name: "GetOrCreateIndex_RequestErrorIndexExists_UpdateTheIndexInMemoryAndGetIt",
			us: &unstructured.Unstructured{
				Object: map[string]interface{}{
					"apiVersion": "apps/v1",
					"kind":       "Deployment",
		...
		{
			name: "GetOrCreateIndex_ResponseErrorIndexExists_UpdateTheIndexInMemoryAndGetIt",
			us: &unstructured.Unstructured{
				Object: map[string]interface{}{
					"apiVersion": "apps/v1",
					"kind":       "Deployment",
		...
		{
			name: "GetOrCreateIndex_IndexNotExist_CreatedThatIndex",
			us: &unstructured.Unstructured{
				Object: map[string]interface{}{
					"apiVersion": "apps/v1",
					"kind":       "Deployment",
		...
		{
			name: "GetOrCreateIndex_WithIndexIsAlreadyInMemory_GotThatIndex",
			us: &unstructured.Unstructured{
				Object: map[string]interface{}{
					"apiVersion": "apps/v1",
					"kind":       "Deployment",
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			gotIndexName, err := test.os.getOrCreateIndex(test.us, true)
			if err == nil && test.wantErr {
