...
type CycleState struct {
	...
	storage sync.Map
	// EnableEmptyWorkloadPropagation enable workload with replicas 0 to be propagated to member clusters.
...
func (c *CycleState) Clone() *CycleState {
	...
	copy.EnableEmptyWorkloadPropagation = c.EnableEmptyWorkloadPropagation
	return copy
}
