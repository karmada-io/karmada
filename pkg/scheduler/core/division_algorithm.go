...
//	scheduledClusters := strategy.findOutScheduledCluster(spec.Clusters, clusters)
//
...
//		newTargetClusters, err := strategy.scaleDownScheduleByReplicaDivisionPreference(spec, preference)
//		if err != nil {
...
//		newTargetClusters, err := strategy.scaleUpScheduleByReplicaDivisionPreference(clusters, spec, preference, scheduledClusters, assignedReplicas)
//		if err != nil {
