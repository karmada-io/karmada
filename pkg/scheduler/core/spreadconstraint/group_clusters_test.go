...
func generateClusterScores() [][]ClusterDetailInfo {
	...
	// score: [75, 20, 55, 90, 35, 60, 85]
	// available: [40, 50, 60, 30, 80, 20, 70]
	info5 := []ClusterDetailInfo{
		{
			Name:              "memberA",
			Score:             75,
			AvailableReplicas: 40,
		...
		},
		{
			Name:              "memberG",
			Score:             85,
			AvailableReplicas: 70,
		},
	}

	return [][]ClusterDetailInfo{info1, info2, info3, info4, info5}
}
