...
## Urgent Update Notes
- For all components with rate limit parameters of 'kube-api-qps' and 'kube-api-burst', and scheduler-estimator with 'cluster-api-qps' and 'cluster-api-burst', these parameters will be stricter and administrators may need to adjust them to get the same effect as before the update. ([#6095](https://github.com/karmada-io/karmada/pull/6095), @zach593)
