...
This proposal extends the `HTTPSource` type in the Karmada CRD specification to include an optional `Proxy` field. This field will specify the proxy server to use when downloading the CRD tarball.
